...
const Features = () => {
  return (
    <div className="bg-feijoa-100  pt-3">
      <div>
        <h2 className="text-4xl text-center my-3 pb-3">Features</h2>
      </div>
      <div className="flex justify-around pb-8 text-center">
        <div className="flex flex-col items-center border-1 border-feijoa-200 bg-feijoa-50 p-5 rounded-lg w-1/5 h-60 shadow-lg">
